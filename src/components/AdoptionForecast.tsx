...
export default function AdoptionForecast({
  countriesData, snapshots, forecastClaims = [], forecastEvaluations = [],
}: {
    ...
    <>
      ...
      <div style={{
        ...
        {mode === 'forecast' ? (
          ...
          /* Evaluation view — rendered once real evaluations exist */
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    borderBottom: '1px solid rgba(255,255,255,0.05)', fontSize: '10px',
                  }}
                >
                  ...
                  <span style={{ color, fontSize: '9px', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
          ...
          /* Empty state — tracking in progress */
          <div style={{ padding: '20px 0' }}>
            ...
            <div style={{ color: 'rgba(255,255,255,0.3)', fontSize: '9px', lineHeight: '1.7', marginBottom: 20, textAlign: 'center' }}>
